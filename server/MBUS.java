...
public class MBUS {
    ...
    public  MBUS(String position,String from) {;
    ...
    private void procFram() {
        try {
            ...
            // fw.close();
            fw = new FileWriter("../MBUS/"+position+".XML");
            fw.write("<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>\r\n<!-- Edited with XML Spy v2007 (http://www.altova.com) -->\r\n<?xml-stylesheet type=\"text/xsl\" href=\"../dispmbus.xsl\"?>\r\n<AIRQ>\r\n");
            ...
            fw.append("\t<VER>"+String.format("%d", RxBuf[28] & 0xff)+"</VER>\r\n");
